    ...
    if (self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == HMSegmentedControlSelectionStyleTextWidthStripe &&
            ...
            if (self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleDynamic) {
                ...
                // HMSegmentedControlSegmentWidthStyleDynamic && HMSegmentedControlSelectionStyleTextWidthStripe 底部滑动条长度等于文本长度
                CGFloat left = selectedSegmentOffset + self.selectionIndicatorEdgeInsets.left + self.segmentEdgeInset.left;
                CGFloat width = [[self.segmentWidthsArray objectAtIndex:self.selectedSegmentIndex] floatValue] - self.selectionIndicatorEdgeInsets.right - self.segmentEdgeInset.left - self.segmentEdgeInset.right;
                return CGRectMake(left, indicatorYOffset, width, self.selectionIndicatorHeight + self.selectionIndicatorEdgeInsets.bottom);
